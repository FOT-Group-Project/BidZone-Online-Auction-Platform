...
public class AdminLogin extends JFrame{
	...
	public AdminLogin() throws UnknownHostException, IOException {
		...
		icon2=new ImageIcon("../ProjectImages2/bg.png");
		
		panel = new JPanel();
		panel.setForeground(new Color(154, 205, 50));
		panel.setBackground(new Color(28, 72, 111));
		panel.setBounds(340, 171, 594, 411);
		panel.setLayout(null);
		contentPane.add(panel);
		
		label_1 = new JLabel("BidZone");
		...
		lblNewLabel.setIcon(new ImageIcon("../ProjectImages2/wlogo.png"));
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			public void mouseExited(MouseEvent e) {
				...
				btnNewButton_1.setForeground(new Color(239,129,33));
			}
