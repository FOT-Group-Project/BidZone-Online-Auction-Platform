...
public class AdminFrame extends JFrame {
	...
	public AdminFrame(AdminLogin parent,ObjectInputStream input,ObjectOutputStream output) throws Exception{
		...
		icon4=new ImageIcon("../ProjectImages2/adminbg.png");
		...
		icon3=new ImageIcon("../ProjectImages2/logox.png");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnNewButton.setBackground(new Color(239,129,33));
				btnNewButton.setForeground(Color.white);
			}
		});
		...
		btnEnterCutoffOf.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnEnterCutoffOf.setBackground(new Color(239,129,33));
				btnEnterCutoffOf.setForeground(Color.white);
			}
		});
		...
		button2.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				button2.setBackground(new Color(239,129,33));
				button2.setForeground(Color.white);
			}
		});
		panel_1.add(button2);
		...
		button_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				button_1.setBackground(new Color(239,129,33));
				button_1.setForeground(Color.white);
			}
		});
		...
		btnShowItems.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnShowItems.setBackground(new Color(239,129,33));
				btnShowItems.setForeground(Color.white);
			}
		});
		...
		btnLogout.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnLogout.setBackground(new Color(239,129,33));
				btnLogout.setForeground(Color.white);
			}
		});
		btnStartAuction.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnStartAuction.setBackground(new Color(239,129,33));
				btnStartAuction.setForeground(Color.white);
			}
		});
		
		lblAuctionBasket = new JLabel("BidZone");
		lblAuctionBasket.setHorizontalAlignment(SwingConstants.CENTER);
		lblAuctionBasket.setForeground(new Color(0, 0, 77));
		lblAuctionBasket.setBounds(690, 25, 340, 35);
		lblAuctionBasket.setFont(new Font("Dialog", Font.BOLD, 35));
		contentPane.add(lblAuctionBasket);
		
		lblPvtltd = new JLabel("Pvt.Ltd.");
		lblPvtltd.setForeground(new Color(0, 0, 77));
